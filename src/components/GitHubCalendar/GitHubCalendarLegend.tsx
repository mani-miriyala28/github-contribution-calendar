...
import { GitHubCalendarLegendProps } from "./types";
...
const GitHubCalendarLegend: React.FC<GitHubCalendarLegendProps> = ({
  ...
  const levels = ["noContributions", "low", "moderate", "high", "veryHigh"];
  
  return (
    <div className="flex items-center justify-end space-x-2 text-sm" style={{ fontSize: `${fontSize}px` }}>
